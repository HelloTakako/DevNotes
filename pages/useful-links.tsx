          ...
          <ul id="links-list">
            ...
            <li className="all design">
              ...
              <ul>
                <li>
                  <a
                    href="https://icomoon.io/#preview-free"
                    rel="noopener noreferrer"
                    target="_blank"
                  >
                    IcoMoon
                ...
                <li>
                  <a
                    href="https://goodstuffnononsense.com/"
                    rel="noopener noreferrer"
                    target="_blank"
                  >
                ...
                <li>
                  <a
                    href="https://icooon-mono.com/?lang=en"
                    rel="noopener noreferrer"
                    target="_blank"
                  >
                    ICOOON MONO
                ...
                <li>
                  <a
                    href="https://www.utf8icons.com/subsets/dingbats"
                    rel="noopener noreferrer"
                    target="_blank"
                  >
                    Dingbats
              ...
              <ul>
                ...
                <li>
                  ...
                  <p className="tool-desc">
                    A self-hosted alternative to Google Analytics which lets you
                    do more analytics and UX research
                  </p>
                </li>
                <li>
                  <a
                  ...
                  <p className="tool-desc">
                    For webpage audits. Available on Google Chrome Extension /
                    Chrome Dev Tools.
                  </p>
                </li>
                <li>
            ...
            <li className="all frontend backend">
              ...
              <ul>
                ...
                <li>
                  ...
                  <p className="tool-desc">Share Code in Real-time</p>
                </li>
                <li>
                  <a
            ...
            <li className="all frontend backend">
              ...
              <ul>
                ...
                <li>
                  ...
                  <p className="tool-desc">Domain name search</p>
                </li>
                <li>
                  <a
                    href="https://codinghub.tips/"
                    rel="noopener noreferrer"
                    target="_blank"
                  >
                    Coding hub tips
                ...
                <li>
                  ...
                  <p className="tool-desc">
                    Domain Name Generator and Search Engine
                  </p>
                </li>
                <li>
                  <a
                ...
                <li>
                  ...
                  <p className="tool-desc">
                    Check browser support for modern web technologies
                  </p>
                </li>
                <li>
                  <a
                ...
                <li>
                  <a
                    href="https://cloudcraft.co/"
                    rel="noopener noreferrer"
                    target="_blank"
                  >
                    Cloudcraft
                  </a>
                  <p className="tool-desc">Draw AWS diagrams</p>
                </li>
                <li>
                  <a
                    href="https://fontflipper.com/upload"
                    rel="noopener noreferrer"
                    target="_blank"
                  >
                    Font Flipper
                ...
                <li>
                  ...
                  <p className="tool-desc">
                    Share remote tunnels from localhost to external servers (so
                    for websites or web apps) with http/https
                  </p>
                </li>
                <li>
                  <a
                  ...
                  <p className="tool-desc">
                    Vanilla JavaScript code snippets alternative to jQuery
                  </p>
                </li>
                <li>
                  <a
                  ...
                  <p className="tool-desc">CSS Flexbox property cheatsheet</p>
                </li>
              </ul>
            </li>
            ...
            <li className="all frontend">
              ...
              <ul>
                <li>
                  ...
                  <p className="tool-desc">
                    Find out what websites are built with. Available both on
                    browser and as an extension
                  </p>
                </li>
                <li>
                  <a
                    href="https://chrome.google.com/webstore/detail/css-peeper/mbnbehikldjhnfehhnaidhjhoofhpehk?hl=en"
                    rel="noopener noreferrer"
                    target="_blank"
                  >
                    CSS Peeper
                ...
                <li>
                  <a
                    href="https://chrome.google.com/webstore/detail/whatfont/jabopobgcpjmedljpbcaablpmlmfcogm?hl=en"
                    rel="noopener noreferrer"
                    target="_blank"
                  >
                    Whatfont
                ...
                <li>
                  <a
                    href="https://chrome.google.com/webstore/detail/mobileresponsive-web-desi/elmekokodcohlommfikpmojheggnbelo?hl=en"
                    rel="noopener noreferrer"
                    target="_blank"
                  >
            ...
            <li className="all design frontend">
              ...
              <ul>
                <li>
                  ...
                  <p className="tool-desc">
                    Generate a color pallete with customizable parameters (hue,
                    saturation, brightness, number of colors)
                  </p>
                </li>
                <li>
                  <a
                ...
                <li>
                  <a
                    href="https://materialuicolors.co/"
                    rel="noopener noreferrer"
                    target="_blank"
                  >
                    material UI Colors
                ...
                <li>
                  <a
                    ...
                    target="_blank"
                  >
                    Canva Color Pallete Generator
                  </a>
                  <p className="tool-desc">
                    Generate a color pallete from an image
                  </p>
                </li>
                <li>
                  <a
            ...
            <li className="all design frontend">
              ...
              <ul>
                <li>
                  ...
                  <p className="tool-desc">For Angular, React.js, Vue.js</p>
                </li>
                <li>
                  <a
                  ...
                  <p className="tool-desc">For React.js</p>
                </li>
                <li>
                  <a
                  ...
                  <p className="tool-desc">For Angular</p>
                </li>
              </ul>
            </li>
            ...
            <li className="all frontend backend">
              ...
              <ul>
                <li>
                  ...
                  <p className="tool-desc">
                    Popular IDE with bunch of useful extensions
                  </p>
                </li>
                <li>
                  <a
                ...
                <li>
                  ...
                  <p className="tool-desc">For hardcore programmers</p>
                </li>
                <li>
                  <a
            ...
            <li className="all frontend backend">
              ...
              <ul>
                ...
                <li>
                  ...
                  <p className="tool-desc">For designing own APIs</p>
                </li>
                <li>
                  <a
            ...
            <li className="all design">
              ...
              <ul>
                ...
                <li>
                  <a
                    href="https://www.logoinspirations.co/"
                    rel="noopener noreferrer"
                    target="_blank"
                  >
                    Logoinspirations
            ...
            <li className="all frontend">
              ...
              <ul>
                ...
                <li>
                  <a
                    href="https://elrumordelaluz.github.io/csshake/"
                    rel="noopener noreferrer"
                    target="_blank"
                  >
                    CSSHake
                ...
                <li>
                  <a
                    href="https://github.com/kristofferandreasen/wickedCSS"
                    rel="noopener noreferrer"
                    target="_blank"
                  >
                    Wicked css
                ...
                <li>
                  <a
                    href="https://github.com/visionmedia/move.js"
                    rel="noopener noreferrer"
                    target="_blank"
                  >
                    move.js
            ...
            <li className="all frontend backend security">
              ...
              <ul>
                ...
                <li>
                  ...
                  <p className="tool-desc">
                    A concise collection of information on specific application
                    security topics
                  </p>
                </li>
                <li>
            ...
            <li className="all ux-seo frontend backend">
              ...
              <ul>
                ...
                <li>
                  ...
                  <p className="tool-desc">
                    Chrome Extension for sharing documentation references easier
                  </p>
                </li>
              </ul>
            </li>
